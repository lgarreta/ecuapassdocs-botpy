...
#define MyAppVersion "0.903"
#define MyInstallerName "EcuapassBot-0903-Instalador"
...
AppId={{6AAB687D-D061-41F4-BB50-5216FD706921}
AppName={#MyAppName}
...
[Files]
Source: "resources\ecuapass_app\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "resources\ecuapass_app\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
