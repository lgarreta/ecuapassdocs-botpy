...
AppId={{17B88E2E-AE5A-4570-9BAE-E2CA8ECBA6F0}
AppName={#MyAppName}
...
[Files]
Source: "resources\ecuapass_app\*"; DestDir: "{app}\{#MyAppName}"; Flags: ignoreversion recursesubdirs
